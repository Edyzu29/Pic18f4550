...
#define LCD_PinD0   PORTBbits.RB0
#define LCD_PinRS   PORTDbits.RD2
#define LCD_PinRW   PORTDbits.RD1    
#define LCD_PinEN   PORTDbits.RD0
...
#define LCD_CfgPinD0   TRISBbits.TRISB0
#define LCD_CfgPinRS   TRISDbits.TRISD2
#define LCD_CfgPinRW   TRISDbits.TRISD1
#define LCD_CfgPinEN   TRISDbits.TRISD0
